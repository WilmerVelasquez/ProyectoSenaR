...
namespace RecursosHumanos.Controllers
{
    ...
    public class HorarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdHorario,NombreHorario,HoraInicio,HoraSalida")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHorario,NombreHorario,HoraInicio,HoraSalida")] Horario horario)
        {
